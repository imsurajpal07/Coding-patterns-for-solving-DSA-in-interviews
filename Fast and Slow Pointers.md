# Fast and Slow Pointers in Java

This repository demonstrates solving classic problems using the **Fast & Slow Pointers technique** (also known as *Floyd’s Cycle Detection Algorithm*).
